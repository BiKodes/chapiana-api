...
class ContactListAPIViewTest(APITestCase):
    ...
    def setUpTestData(self):
        test_user = User.objects.create(id=1, username="zulu", password="123456")
    ...
    def test_post_contact_can_be_created_with_data(self):
        ...
        response = self.client.post(self.contacts_url, self.contact_data)
...
class ContactDetailAPIViewTest(APITestCase):
    @classmethod
    def setUpTestData(self):
        self.test_user = User.objects.create(id=1, username="zulu", password="123456")
